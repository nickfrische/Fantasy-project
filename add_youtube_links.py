...
def main():
    csv_files = [
        ('qb_top100.csv', 'qb_top100_with_links.csv'),
        ('rb_top100.csv', 'rb_top100_with_links.csv'),
        ('te_top100.csv', 'te_top100_with_links.csv'),
        ('wr_top100.csv', 'wr_top100_with_links.csv')
    ]
